...
<body class="bg-gray-100">
    @if (request()->has('success'))
        <div id="success-notification" class="fixed top-4 left-0 right-0 z-50 flex justify-center pointer-events-none">
            <div
                class="animate-fade-in-up bg-white shadow-lg rounded-lg border border-green-100 overflow-hidden w-full max-w-md">
                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="p-3">
                                    <button
                                        class="bg-red-500 text-white px-3 py-1 rounded hover:bg-red-600">Cancel</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
